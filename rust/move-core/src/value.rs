...
impl fmt::Display for MoveValue {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            MoveValue::U8(u) => write!(f, "{}", u),
            MoveValue::U16(u) => write!(f, "{}", u),
            MoveValue::U32(u) => write!(f, "{}", u),
            MoveValue::U64(u) => write!(f, "{}", u),
            MoveValue::U128(u) => write!(f, "{}", u),
            MoveValue::U256(u) => write!(f, "{}", u),
